...
OUT=os.path.join(os.environ.get("SHOT_DIR", os.path.join(os.path.dirname(__file__), "..", "..", ".build", "shots")), "shots3"); os.makedirs(OUT, exist_ok=True)
...
with sync_playwright() as p:
    ...
    good("Urby is present on the details screen")
