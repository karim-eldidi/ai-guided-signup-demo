...
const POSTCODES = {
  ...
  '10777':'charlottenburg','10779':'charlottenburg','10781':'kreuzberg','10783':'mitte','10823':'kreuzberg','10825':'charlottenburg','10827':'charlottenburg','10829':'kreuzberg',
      ...
      if (area) {
        ...
        if (!addedKeys.has(key)) {
          ...
          results.push({
            ...
            areaName: area.name,
            sub: `Postcode in ${area.name} · ~3 km`,
            icon: 'pin'
          });
        }
      }
    ...
    if (n.includes(q) || nClean.includes(qClean)) {
      ...
      if (!addedKeys.has(key)) {
        ...
        results.push({
          ...
          label: `${a.name}, Berlin`,
          areaName: a.name,
          sub: `${plural(venueCount, 'venue', 'venues')} · ~3 km`,
          icon: 'pin'
        });
      }
    }
