...
export const icons = {
  ...
  video: (s) => wrap('<polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/>', s),
  play: (s) => wrap('<polygon points="5 3 19 12 5 21 5 3"/>', s),
  pause: (s) => wrap('<rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/>', s),
